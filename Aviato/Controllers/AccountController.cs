...
namespace Aviato.Controllers
{
    ...
    public class AccountController : Controller
    {
                ...
                if (result.Succeeded)
                {
                    ...
                    else if (rola == "Stjuard")
                    {
                        ...
                        if (ModelState.IsValid)
                        {
                            ...
                            //ViewBag.JeziciZaUnos = "javascript:JeziciZaUnos();";
                            

                            foreach (var item in jezici)
                            {
                                Stjuard stju = new Stjuard();
                                stju.StjuardId = model.Zaposleni.ZaposleniId;
                                stju.JezikId = Convert.ToInt32(item);
                    ...
                    {
                        var licence = model.tipoviZaUnos.Split(',');
                        var datumi = model.datumiZaUnos.Split(',');
                        for (var i = 0; i < licence.Length; i++)
                        {
                            Mehanicar Mehanicar = new Mehanicar();

                            Mehanicar.MehanicarId = model.Zaposleni.ZaposleniId;
                            Mehanicar.Licenca = Convert.ToInt32(licence[i]);
                            Mehanicar.DatumLicence = Convert.ToDateTime(datumi[i]);
                    ...
                    //var detalji = await zaposleni(Ime, Prezime, JMBG, GodinaRodjenja);
        ...
        //private string JeziciZaUnos()
        //{
        //    throw new NotImplementedException();
        //}

        private dynamic JavaScript()
        {
            throw new NotImplementedException();
        }
        ...
        //    {
        //        tipovi.Add(new SelectListItem() { Value = tip.NazivTipa, Text = tip.NazivTipa });
        //    }
        //    ViewBag.Tip = tipovi;
        //}
